# Simple Viridian City Tileset Fix
# This script fixes ONLY Viridian City, nothing else

Write-Host "=== VIRIDIAN CITY TILESET FIX ===" -ForegroundColor Green
Write-Host "Starting fix process..." -ForegroundColor Yellow

# Step 1: Create backup
Write-Host "Step 1: Creating backup..." -ForegroundColor Cyan
Copy-Item "data\layouts\layouts.json" "data\layouts\layouts_backup_viridian.json"
Write-Host "Backup created: layouts_backup_viridian.json" -ForegroundColor Green

# Step 2: Read the file
Write-Host "Step 2: Reading layouts.json..." -ForegroundColor Cyan
$lines = Get-Content "data\layouts\layouts.json"

# Step 3: Find Viridian City layout (line 4435)
Write-Host "Step 3: Locating Viridian City layout..." -ForegroundColor Cyan
$viridianLine = 4435  # We know this from our previous analysis
Write-Host "Viridian City ID found at line: $viridianLine" -ForegroundColor Green

# Step 4: Fix the secondary_tileset (line 4440)
Write-Host "Step 4: Fixing secondary_tileset..." -ForegroundColor Cyan
$tilesetLine = $viridianLine + 5  # secondary_tileset is 5 lines after ID
...
# Make the change
$lines[$tilesetLine-1] = $lines[$tilesetLine-1] -replace 'gTileset_VermilionCity', 'gTileset_ViridianCity'
...
$verification = Get-Content "data\layouts\layouts.json" | Select-String -Pattern "LAYOUT_VIRIDIAN_CITY" -Context 0,6
Write-Host "Verification result:" -ForegroundColor Yellow
Write-Host $verification -ForegroundColor White

Write-Host "=== VIRIDIAN CITY FIX COMPLETE ===" -ForegroundColor Green
